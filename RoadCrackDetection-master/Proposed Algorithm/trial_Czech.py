...
def detect(source, save_img=True):
    ...
    weights = 'D:/RoadDetection/001/RoadCrackDetection-master/Proposed Algorithm/model/jc66.pt'    #Pass the correct path of the model
    view_img = True
    save_txt = False 
    imgsz  = 640
    device = ''
...
with torch.no_grad():
    ...
    cnts = ['Czech']    #VM
    for cnt in cnts:
        img_source =os.path.join('D:/RoadDetection/001/RoadCrackDetection-master/Proposed Algorithm/data/test1',cnt,'images')       #Pass the correct path of the test1 dataset
